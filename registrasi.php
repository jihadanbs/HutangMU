...
<head>
  ...
  <title>HutangMU | Registrasi</title>
  ...
  <style>
    body {
      background: url('img/bghutang.png');
    ...
    .img {
      background: url('img/logoHutang.png');
      background-size: cover;
      background-position: center;
      height: 100%;
      top: 0;
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Registrasi untuk gunakan HutangMU</div>
              </div>
              ...
              <div class="card-body">
                <form method="POST">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" name="username-registrasi" class="form-control" placeholder="Nama Pengguna" autocomplete="off" required>
                  </div>
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" name="usaha-registrasi" class="form-control" placeholder="Nama Usaha" autocomplete="off" required>
                  </div>
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="password" name="password-confirm" class="form-control" placeholder="Konfirmasi password" autocomplete="off" required>
                  </div>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="signup" style="margin-left: 90px; text-decoration: none">
                  <h4>> Registrasi <</h4>
                </div>
                <!--<div class="sub-title">Login untuk gunakan inDesa</div>-->
              </div>
              <div class="icon-user">
                <h4 class="fa fa-user"></h4>
              </div>
              <div class="content" style="margin-left: 120px; margin-top: 60px; text-decoration: none;">
                  <div class="isi mx-auto ">
                      <h2>Registrasi</h2>
                      <h4>Klik Tombol</h4>
                      <h4>Diatas</h4><br>
                          <a href="index" style="margin-left: 30px; text-decoration: none;" class="btn btn-primary button">Logout</a>
                  </div>
              </div>
