...
function fetchData()
{
     ...
     $hasil .= '
     <tr>
          <td colspan="4" style="text-align: center;">Total Hutang</td>
          <td>' . $hasilJumlah2 . '</td>
     </tr>
     ';
     return $hasil;
...
if (isset($_POST["pdf"])) {
     ...
     $obj_pdf->SetTitle("Laporan Hutang");
     ...
     $content = '';
     $content .= '  
     <h4 align="center">Laporan Hutang</h4><br/> 
     ...
     <tr>  
          ...
          <th width="24%">Keterangan Hutang</th>
          <th width="14%">Sumber Hutang</th>
          <th width="14%">Nominal Hutang</th>
     </tr>  
     ';
     $content .= fetchData();
     $content .= '</table>';
     $obj_pdf->writeHTML($content);
     $obj_pdf->Output('Laporan Hutang.pdf', 'I');
}
?>