...
<head>
    ...
    <title>HutangMU | Dashboard</title>
                            ...
                            <div class="card card-stats card-warning" style="background: #347ab8;">
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-7 d-flex align-items-center tulisan">
                                            <div class="numbers">
                                                <p class="card-category ket head">Nama Usaha</p>
                                                <?php
                        
                                                        $dataAwal = mysqli_query($koneksi, "SELECT * FROM users WHERE username='$_SESSION[user]'");
                                                        $awal = mysqli_fetch_array($dataAwal);
                                                            ?>
                                                <h4 class="card-title ket total"><?=$awal['nama_usaha'];?></h4>
                                ...
                                <div class="card card-stats card-warning" style="background: #5db85b;">
                                    <div class="card-body ">
                                        <div class="row">
                                            ...
                                            <div class="col-7 d-flex align-items-center tulisan">
                                                <div class="numbers">
                                                    <p class="card-category ket head">Piutang</p>
                                ...
                                <div class="card card-stats card-warning" style="background: #d95350;">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-7 d-flex align-items-center tulisan">
                                                <div class="numbers">
                                                    <p class="card-category ket head">Hutang</p>
                            ...
                            <div class="card card-stats card-warning" style="background: #347ab8;">
                                <div class="card-body ">
                                    <div class="row">
                                        <div class="col-5">
                                            <div class="icon-big text-center">
                                                <i class="fas fa-calendar ikon"></i>
                                            </div>
                                        </div>
                                        
                                        <div class="col-7 d-flex align-items-center tulisan">
                                            <div class="numbers">
                                                <p class="card-category ket head">Awal Subs</p>
                                                <?php
                        
                                                        $dataAwal = mysqli_query($koneksi, "SELECT * FROM users WHERE username='$_SESSION[user]'");
                                                        $awal = mysqli_fetch_array($dataAwal);
                                                            ?>
                                                <h4 class="card-title ket total"><?=$awal['awal_buat'];?></h4>
                            ...
                            <div class="card card-stats card-warning" style="background: #347ab8;">
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-7 d-flex align-items-center tulisan">
                                            <div class="numbers">
                                                <p class="card-category ket head">Akhir Subs</p>

                                                <h4 class="card-title ket total"><?=$MembershipEnds?> </h4>
                            ...
                            <div class="card card-stats card-warning" style="background: #347ab8;">
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-7 d-flex align-items-center tulisan">
                                            <div class="numbers">
                                                <p class="card-category ket head">Status</p>
                                                <?php if(date("Y-m-d") < $MembershipEnds){ ?>
                                                    <h4 class="card-title ket total">Membership anda aktif</h4>
                                                    <?php } else { ?>
                                                        <h4 class="card-title ket total">Membership anda sudah kadaluwarsa</h4>
                                                    <?php }  ?>
