...
<body>
    ...
    <div class="main-content khusus">
        <div class="konten khusus2">
            <div class="konten_dalem khusus3">
                <h2 class="head" style="color: #4b4f58;">Piutang</h2>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-hover table-striped table-bordered">
                                    ...
                                    <tr class="show" id="<?= $row['id'] ?>">
                                        ...
                                        <td data-target="pelanggan"><?= htmlspecialchars($row['pelanggan']) ?></td>
                                        <td data-target="hp"><?= htmlspecialchars($row['hp']) ?></td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Data Piutang</h5>
                ...
                <!-- isi form -->
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="pelangganTambah" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Masukkan Nomor Hp</label>
                            <input type="text" id="hpTambah" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Masukkan Keterangan Piutang</label>
                            <input type="text" id="keteranganTambah" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Masukkan Keperluan Piutang</label>
                            <select id="keperluanTambah" class="form-control">
									<option>Makanan</option>
									<option>Minuman</option>
									<option>Snack</option>
									<option>Bakaran</option>
									<option>Baju</option>
                        ...
                        <div class="form-group">
                            <label>Masukkan Nominal Piutang</label>
    ...
    <div class="modal fade" id="myModal2" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Ubah Data Piutang</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="keterangan">Nomor Hp</label>
                        <input type="text" class="form-control" id="hp" required>
                    </div>
                    <div class="form-group">
                        <label for="keterangan">Keterangan Piutang</label>
                        <input type="text" class="form-control" id="keterangan" required>
                    </div>
                    <div class="form-group">
                        <label for="keperluan">Keperluan Piutang</label>
                    ...
                    <div class="form-group">
                        <label for="jumlahKeluar">Jumlah Piutang</label>
    ...
    <script src="ajax/js/tambahPiutang.js"></script>
    <script src="ajax/js/deletePengeluaran.js"></script>
    <script src="ajax/js/cariPiutang.js"></script>
    <script src="ajax/js/updatePiutang.js"></script>
