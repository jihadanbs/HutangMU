...
<body>
	...
	<div class="main-content khusus">
		<div class="konten khusus2">
			<div class="konten_dalem khusus3">
					<h2 class="head" style="color: #4b4f58;">Hutang</h2>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalCenterTitle">Tambah Data Hutang</h5>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="text" name="pelanggan" class="form-control" id="pTambah" required>
						</div>
						<div class="form-group">
							<label>Masukkan Nomor Hp</label>
							<input type="text" name="hp" class="form-control" id="hTambah" required>
						</div>
						<div class="form-group">
							<label>Masukkan Keterangan Hutang</label>
							<input type="text" name="keterangan" class="form-control" id="keteranganTambah" required>
						</div>
						<div class="form-group">
							<label>Masukkan Sumber Hutang</label>
						...
						<div class="form-group">
							<label>Masukkan Jumlah Hutang</label>
	...
	<div class="modal fade" id="myModal2" data-backdrop="static">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalCenterTitle">Ubah Data Hutang</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="sumber">Sumber Hutang</label>
						...
						<div class="form-group">
							<label for="jumlahMasuk">Jumlah Hutang</label>
	...
	<script src="ajax/js/tambahHutang.js"></script>
	<script src="ajax/js/deletePemasukkan.js"></script>
	<script src="ajax/js/cariHutang.js"></script>
	<script src="ajax/js/updateHutang.js"></script>
