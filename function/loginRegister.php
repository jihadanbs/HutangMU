...
for ($i = 0; $i < $panjang; $i++) {
    $acak .= $karakter[rand(0, $panjang_karakter - 1)];
}
...
function register($dataRegister) {
    ...
    $usaha = htmlspecialchars( stripcslashes( $dataRegister['usaha-registrasi'] ));
    ...
    $no_rek = acak(12);
    $sukses = mysqli_query($koneksi, "INSERT INTO users (email, username, password, no_rek, nama_usaha) VALUES ('$email', '$username', '$password', '$no_rek', '$usaha')");
