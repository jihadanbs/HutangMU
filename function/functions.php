<?php 
    $koneksi = mysqli_connect('localhost', 'root', '', 'hutangmu');
    ...
    function tambahMasuk($dataMasuk) {
        ...
        $pelanggan = htmlspecialchars($dataMasuk["pelanggan"]);
        $hp = htmlspecialchars($dataMasuk["hp"]);
        ...
        // query insert data
        $query = "INSERT INTO pemasukkan (id, tanggal, pelanggan, hp, keterangan, sumber, jumlah, username) VALUES (NULL, '$tanggalMasuk', '$pelanggan', '$hp',  '$keteranganMasuk', '$sumber', '$jumlah', '$username')";
    ...
    function tambahKeluar($dataKeluar) {
        ...
        $pelanggan = htmlspecialchars($dataKeluar["pelanggan"]);
        $hp = htmlspecialchars($dataKeluar["hp"]);
        ...
        // query insert data
        $query = "INSERT INTO pengeluaran (id, tanggal, pelanggan, hp, keterangan, keperluan, jumlah, username) VALUES (NULL, '$tanggalKeluar', '$pelanggan', '$hp', '$keteranganKeluar', '$keperluan', '$jumlah', '$username')";
        mysqli_query($koneksi, $query);           
