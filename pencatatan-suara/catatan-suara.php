...
<head>
    ...
    <title>HutangMU | Catatan Suara</title>
    ...
    <div class="container">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" placeholder="Masukkan Nama Pelanggan">
            </div>

            <div class="form-group">
                <label for="name">Nomor Hp</label>
                <input type="text" class="form-control" id="hp" placeholder="Masukkan Nomor Hp Pelanggan">
            </div>
